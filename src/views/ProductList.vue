          ...
          <div class="row">
            ...
            <div class="col-12">
              <div v-for="category in products" :key="category.id">
                <p>
                  {{
                    category.description[locale] || category.description.zh_TW
                  }}
                </p>
                ...
                <div class="row mt-4">
                  ...
                  >
                    <a :href="`/${locale}/product/${product.id}`">
                      <img
                        :src="
                          product.feature_image.find(
                            (img) => img.language === locale
                          )?.meta_value ||
                          product.feature_image.find(
                            (img) => img.language === 'zh_TW'
                          )?.meta_value
                        "
                        :alt="product.title[locale] || product.title.zh_TW"
                        class="img-fluid product_image w-100"
                      />
                      <p class="mt-2">
